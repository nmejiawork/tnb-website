...
shortDef: >-
  A product manager who specializes in AI-native products, meaning products
  where the model output is the core user experience. The role requires
  understanding model capabilities, evaluation design, prompt strategy, and how
  to ship reliably when non-determinism is a first-class concern.
---
