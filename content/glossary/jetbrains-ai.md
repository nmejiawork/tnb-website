...
shortDef: >-
  AI coding assistance built natively into JetBrains IDEs like IntelliJ,
  PyCharm, WebStorm, and GoLand. Offers inline completions, chat, and code
  generation without switching to a separate tool, for teams already in the
  JetBrains ecosystem.
---
