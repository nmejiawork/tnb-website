...
shortDef: >-
  An AI-native code editor by Codeium (a coding AI company) built around
  Cascade, an agentic model that tracks your recent files, terminal output, and
  editor activity to stay in context without needing constant re-prompting.
---
