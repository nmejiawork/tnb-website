...
shortDef: >-
  The first widely-publicized commercial AI software engineer, from Cognition
  AI. Devin can handle end-to-end software tasks: reading requirements, writing
  code, running tests, debugging, and deploying, with minimal human
  intervention.
---
