...
shortDef: >-
  The ability to send images, PDFs, audio, video, or other non-text content to a
  model alongside or instead of text. Most frontier models now accept multiple
  input types; what you can do with them varies significantly by model and
  provider.
---
