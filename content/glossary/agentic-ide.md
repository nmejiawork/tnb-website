...
shortDef: >-
  A code editor built around AI agent workflows rather than traditional
  autocomplete. Agentic IDEs let you describe a task, review the agent's plan,
  watch it edit files across your codebase, and accept or reject changes, all
  within the editor.
---
