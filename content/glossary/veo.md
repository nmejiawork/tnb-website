...
shortDef: >-
  Google's AI video generation model. Veo 3 is the current version, notable for
  generating video with synchronized audio including dialogue, sound effects,
  and background music, not just silent clips. Available in the Gemini app and
  via Vertex AI.
---
