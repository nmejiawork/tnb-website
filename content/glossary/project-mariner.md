...
shortDef: >-
  Google's web-browsing agent built on Gemini. It can navigate websites, fill
  forms, and complete multi-step tasks in a browser on your behalf, the Google
  counterpart to OpenAI's Operator.
---
