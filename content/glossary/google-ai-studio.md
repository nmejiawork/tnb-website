...
shortDef: >-
  Google's web-based IDE for building with Gemini models. You can prototype
  prompts, test multimodal inputs, get API keys, explore model capabilities, and
  vibe-code apps directly from the browser, all before writing a line of
  production code.
---
